...
//            {title: '续报数', dataIndex: 'xbnum', width: '60px',key:'xbnum', align: 'center',},
            ...
            {title: '详细描述',dataIndex: 'jbms', width: '200px',key:'jbms', align: 'left',titleAlign:'center'},
            {title: '接报时间',dataIndex: 'jbtime', width: '80px',key:'jbtime', align: 'center'},
            {title: '发生时间',dataIndex: 'fstime', width: '80px',key:'fstime', align: 'center'},
