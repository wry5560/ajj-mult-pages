...
<script>
  ...
  const getList='query_qiyezicha_zclist'                //获取table的list
  ...
  const reqList='reqQiyeZichaInfoList'                   //查询列表
      ...
      return{
        ...
        table:{
          ...
          columns:[
            ...
            {title: '排查清单名称',dataIndex: 'gdNm', width: '180px', align: 'left',titleAlign:'center'},
            ...
            {title: '开始日期', dataIndex: 'startDate', width: '100px', align: 'center',titleAlign:'center'},
            {title: '结束日期', dataIndex: 'endDate', width: '120px', align: 'center',titleAlign:'center'},
...
//            {title: '隐患数/整改数', dataIndex: 'yhzg', width: '120px', align: 'center',titleAlign:'center'},
            {title: '是否完成', dataIndex: 'sfwc', width: '80px', align: 'center',titleAlign:'center', scopedSlots: {customRender: 'sfwc'}},
...
//              "min-height":window.innerHeight-80 + 'px',
    ...
    created(){
      ...
      this.pagination.total=this.query_qiyezicha_zcTotalCount()

      this.table.columns=initColumn(this.table.columns)
    },
    methods:{
      moment,
      ...mapGetters(['getQiyeZiChaSearchValues','query_qiyezicha_zcTotalCount']),
      ...mapActions(['','']),
