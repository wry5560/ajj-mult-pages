...
//  import jcDetail from '@/Pages/Jc/comps/jcDetail.vue'
  ...
  const getList='query_qiyejc_yhlist'                //获取table的list
      ...
      return{
        ...
        table:{
          ...
          columns:[
            ...
            {title: '隐患内容',dataIndex: 'yhnr', width: '250px', align: 'left',titleAlign:'center'},
...
//            {title: '隐患数/整改数', dataIndex: 'yhzg', width: '120px', align: 'center',titleAlign:'center'},
            ...
            {title: '复查人', dataIndex: 'fcuser', width: '100px', align: 'left',titleAlign:'center'},
...
//              "min-height":window.innerHeight-80 + 'px',
    ...
    created(){
      ...
      this.pagination.total=this.query_qiyejc_yhTotalCount()

      this.table.columns=initColumn(this.table.columns)
    },
    methods:{
      moment,
      ...mapGetters(['getQiyeJcSearchValues','query_qiyejc_yhTotalCount']),
      ...mapActions(['','']),
