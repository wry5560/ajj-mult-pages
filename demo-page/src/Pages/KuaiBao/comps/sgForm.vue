  ...
  <div >
    <a-form @submit="handleSubmit" :form="form" >
      <a-row :gutter="16">
        ...
        <a-divider orientation="">单位信息</a-divider>
        <a-col :lg="8" :md="12" :sm="24">
        ...
        <a-divider orientation="">伤亡及损失</a-divider>

        <a-col :lg="8" :md="12" :sm="24">
          <a-form-item label="死亡人数" :labelCol="{ span: 6 }" :wrapperCol="{ span: 18 }">
            <a-input size="small" placeholder="请输入死亡人数" v-decorator="['swrs',]" />
          </a-form-item>
        </a-col>
        <a-col :lg="8" :md="12" :sm="24">
          <a-form-item label="受伤人数" :labelCol="{ span: 6 }" :wrapperCol="{ span: 18 }">
            <a-input size="small" placeholder="请输入受伤人数" v-decorator="['ssrs',]" />
          </a-form-item>
        </a-col>
        <a-col :lg="8" :md="12" :sm="24">
          <a-form-item label="重伤人数" :labelCol="{ span: 6 }" :wrapperCol="{ span: 18 }">
            <a-input size="small" placeholder="请输入重伤人数" v-decorator="['zsrs',]" />
          </a-form-item>
        </a-col>
        <a-col :lg="8" :md="12" :sm="24">
          <a-form-item label="涉险人数" :labelCol="{ span: 6 }" :wrapperCol="{ span: 18 }">
            <a-input size="small" placeholder="请输入涉险人数" v-decorator="['sxrs',]" />
          </a-form-item>
        </a-col>
        <a-col :lg="8" :md="12" :sm="24">
          <a-form-item label="失踪人数" :labelCol="{ span: 6 }" :wrapperCol="{ span: 18 }">
            <a-input size="small" placeholder="请输入失踪人数" v-decorator="['szrs']" />
          </a-form-item>
        </a-col>
        <a-col :lg="8" :md="12" :sm="24">
          <a-form-item label="经济损失" :labelCol="{ span: 6 }" :wrapperCol="{ span: 18 }">
            <a-input size="small" placeholder="请输入直接经济损失" v-decorator="['jjss']" />
          </a-form-item>
        </a-col>
        <a-divider orientation="">详细信息</a-divider>
        <a-col :lg="8" :md="12" :sm="24">
        ...
        <a-col :lg="24">
          <a-form-item label="事故简况" :labelCol="{ span: 2 }" :wrapperCol="{ span: 22 }">
            <a-textarea size="small" placeholder="请输入事故简况" :autosize="{ minRows: 2, maxRows: 6 }"v-decorator="['sgjk',]" />
          </a-form-item>
        </a-col>
        <a-col :lg="24">
