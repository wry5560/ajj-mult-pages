            ...
            <div class="fcjl-detail">
              <div>
                ...
                <a-row :gutter="8" align="top">
                  ...
                  <a-col :lg="12">
                    <span class="item-title"><strong>复查时间：</strong></span>
                    <span class="item-content" >{{fctime}}</span>
                  </a-col>
                </a-row>
                <a-row :gutter="8" align="top">
                  <a-col :lg="12">
                  ...
                  <a-col :lg="12">
                    ...
                    <span class="item-content">{{jcd.fcusersname}}</span>
                  </a-col>
                </a-row>
                <a-row :gutter="8" align="top">
                  <a-col :lg="12">
                  ...
                  <a-col :lg="12">
                    <span class="item-title"><strong>复查专家：</strong></span>
                    <span class="item-content" >{{jcd.fczjname}}</span>
                  </a-col>
                </a-row>
              </div>
              <a-divider/>
                ...
                <a-list :dataSource="jcddetail" bordered>
                  ...
                  <a-list-item slot="renderItem" slot-scope="item, index">
                    <div style="width: 100%;">
                      ...
                      <a-row v-if="(item.yhnr && item.yhnr!='')||(item.sysnr && item.sysnr!='')" :gutter="16" style="margin-top: 12px">
                      <a-col :lg="20" :md="24">
