    ...
    <div>
      ...
      <div >
        <a-pagination
          ...
          size="small"/>
        <a-button type="primary" style="float: right;margin-top: 8px;margin-bottom: 8px;margin-right: 16px" size="small" @click="showModal('add')">添加检查项</a-button>
...
<script>
  ...
  const pageName='jxgl_zxjc_jcx'
  const modalTitle="检查项"   //模态框的title标题
...
//            {title: '条目类型',dataIndex: 'tmlx', width: '80px', align: 'center'},
            {title: '检查类型', dataIndex: 'jclx', width: '120px', align: 'center'},
