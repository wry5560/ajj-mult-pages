  ...
  <div style="width: 300px;height: 100%;position: relative">
    ...
    >
      ...
      <a-sub-menu key="sub4">
        ...
        <a-menu-item key="14">Option 11</a-menu-item>
        <a-menu-item key="15">Option 12</a-menu-item>
        <a-menu-item key="16">Option 10</a-menu-item>
        <a-menu-item key="17">Option 11</a-menu-item>
        <a-menu-item key="18">Option 12</a-menu-item>
      </a-sub-menu>
    </a-menu>
  </div>
</template>
